...
public class Player5Vermelho : MonoBehaviour {
	public 		GameObject	 PAmarelo, PAzul, PMarrom, PRosa, PRoxo, PVerde, PDiminue;
	private 	int 		 Item;
	...
	void OnTriggerEnter(Collider BallMudaCor)
	{
		...
		else if (BallMudaCor.gameObject.tag == "BVermelho") {
