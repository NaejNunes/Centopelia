...
public class PlayerRosa : MonoBehaviour
{
	public		 GameObject 	PAmarelo, PAzul, PMarrom, PRoxo, PVerde, PVermelho, PAumenta, PDiminue;
	private 	 int 			Item;
	...
	void OnTriggerEnter(Collider BallMudaCor)
	{
		if (BallMudaCor.gameObject.tag == "BMudaCor")
		{
			...
			switch (Item)
			{
                ...
                case 5:
                    GameObject Item5 = Instantiate(PVermelho) as GameObject;                  
                    break;
		...
		else if(BallMudaCor.gameObject.tag == "BRosa"){
